...
public sealed partial class RecentlyAdded : Page
{
	...
	private void ListView_ItemClick(object sender, ItemClickEventArgs e)
	{
		...
		Windows.Storage.ApplicationData.Current.LocalSettings.Values[nameof(LocalSave.CurrentPlayinglist)] = "RecentlyAdded";
	}
	...
	private async void ShuffleAndPlayButton_OnClick(object sender, RoutedEventArgs e)
	{
		...
		var localSettings = Windows.Storage.ApplicationData.Current.LocalSettings;
		localSettings.Values[nameof(LocalSave.CurrentPlayinglist)] = "RecentlyAdded";
	...
	private void RecentlyAdded_Unloaded(object sender, RoutedEventArgs e)
	{
		_timer?.Stop();
	}
}
