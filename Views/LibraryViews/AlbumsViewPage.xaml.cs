...
/// </remarks>
public sealed partial class AlbumsViewPage : TileListPageBase
{
	/// <summary>
	...
	/// <inheritdoc/>
	protected override Page CreateFreshPage() => new AlbumsViewPage();

	/// <inheritdoc/>
	protected override async Task OnLibraryReadyAsync()
	{
	...
	/// </remarks>
	/// <inheritdoc/>
	protected override ListViewBase TileView => AlbumTileView;
	...
	private void Page_SizeChanged(object sender, SizeChangedEventArgs e)
	{
		...
		_dispatcherQueue.TryEnqueue(DispatcherQueuePriority.Normal, async () => await AdjustAlphabetSize());
	}
